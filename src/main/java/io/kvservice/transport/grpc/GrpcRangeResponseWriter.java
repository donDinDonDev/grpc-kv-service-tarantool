...
final class GrpcRangeResponseWriter {
    ...
    GrpcRangeResponseWriter(ServerCallStreamObserver<RangeItem> responseObserver, RequestBudget requestBudget) {
    ...
    private void awaitReady() {
        while (!this.responseObserver.isReady()) {
            ...
            long waitNanos = Math.min(this.requestBudget.remainingTimeout().toNanos(), MAX_WAIT_SLICE_NANOS);
