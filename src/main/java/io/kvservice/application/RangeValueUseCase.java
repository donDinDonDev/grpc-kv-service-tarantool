...
public final class RangeValueUseCase {
    ...
    public RangeValueUseCase(KeyValueStoragePort storage, KeyValueValidator validator, int batchSize) {
        if (batchSize <= 0) {
    ...
    public void stream(String keySince, String keyTo, RequestBudget requestBudget, Consumer<StoredEntry> itemConsumer) {
        ...
        while (true) {
            ...
            List<StoredEntry> batch = this.storage.getRangeBatch(
