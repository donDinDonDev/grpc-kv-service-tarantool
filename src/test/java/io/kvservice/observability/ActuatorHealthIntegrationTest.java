...
class ActuatorHealthIntegrationTest {
  ...
  void splitManagementPortKeepsLivenessAndReadinessSemanticsOnBothSurfaces() throws Exception {
    HttpResponse<String> livenessBeforeFailure =
        get(this.managementPort, "/actuator/health/liveness");
    HttpResponse<String> readinessBeforeFailure =
        get(this.managementPort, "/actuator/health/readiness");
    ...
    HttpResponse<String> readinessAfterFailure =
        get(this.managementPort, "/actuator/health/readiness");
    HttpResponse<String> livenessAfterFailure =
        get(this.managementPort, "/actuator/health/liveness");
    ...
    assertThat(readinessAfterFailure.body())
        .containsAnyOf("\"status\":\"DOWN\"", "\"status\":\"OUT_OF_SERVICE\"");
    ...
    assertThat(readyzAfterFailure.body())
        .containsAnyOf("\"status\":\"DOWN\"", "\"status\":\"OUT_OF_SERVICE\"");
