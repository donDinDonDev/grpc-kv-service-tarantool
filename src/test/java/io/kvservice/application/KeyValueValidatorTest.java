...
class KeyValueValidatorTest {
    ...
    private final KeyValueValidator validator = new KeyValueValidator(DataSize.ofBytes(4), DataSize.ofBytes(3));
    ...
    void requiresExplicitValueAndRejectsOversizedPayload() {
        ...
        assertThatThrownBy(() -> this.validator.validateValue(StoredValue.bytes(new byte[] { 1, 2, 3, 4 })))
                .isInstanceOf(InvalidArgumentException.class)
